...
# Recovery command
recovery_command = SetTargetPositionRequest()
recovery_command.command = "recovery"
...
recovery_button_visualize = Button(window, text="Visualize \nRecovery", command=TrajectoryPlanner(recovery_command, False).trajectory_service_caller)
...
recovery_button_visualize.grid(row=1, column=4, padx = 10, pady = 10)
homecoming_button_visualize.grid(row=1, column=5, padx = 10, pady = 10)
...
recovery_button_execute.grid(row=2, column=4, padx = 10, pady = 10)
homecoming_button_execute.grid(row=2, column=5, padx = 10, pady = 10)

dynamixel_label.grid(row=3, column=1, columnspan=4, padx=10, pady=10)
dynamixel_drop_button.grid(row=4, column=2, padx = 10, pady = 10)
dynamixel_reposition_button.grid(row=4, column=3, padx = 10, pady = 10)

info_label.grid(row=5, column=2, columnspan=3, padx = 10, pady = 10)
exit_button.grid(row=6, column=2, columnspan=3, padx = 10, pady = 10)
