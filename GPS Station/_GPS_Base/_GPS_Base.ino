// Acquire data for averaging fixed position of base station. 
...
void loop() {
  if ( processGPS() ) {
    ...
    if (GPSFile) {
      ...
      GPSFile.print(posllh.lat / 10000000., 9);
      GPSFile.print(", ");
      GPSFile.print(posllh.lon / 10000000., 9);
      GPSFile.print(", height: ");
      GPSFile.println(posllh.height / 1000., 6);
      GPSFile.close();
    }
  }
}
